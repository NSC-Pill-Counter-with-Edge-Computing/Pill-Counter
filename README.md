...
- **Overlapping Elimination Mechanism (กลไกแก้ปัญหายาซ้อนทับ):**
  ...
  - สั่งการ **มอเตอร์สั่นถาดนับยาอัตโนมัติ (Tray Vibration Motor)** เมื่อพบเม็ดยาวางทับซ้อนกัน เพื่อสลายกลุ่มก้อนยา
- **Standalone & Offline Operation:** ทำงานได้โดยไม่ต้องเชื่อมต่ออินเทอร์เน็ต แสดงผลผ่านหน้าจอ LCD / Web Application
- **Patient Safety Support:** ส่งสัญญาณเสียงเตือน (Buzzer) เมื่อกระบวนการนับเสร็จสิ้น หรือตรวจพบความคลาดเคลื่อน
